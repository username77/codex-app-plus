...
const COMMANDS = Object.freeze<ReadonlyArray<ComposerSlashDefinition>>([
  ...
  { id: "init", description: "生成 AGENTS.md 指令文件。", flavor: "official", executionKind: "unavailable", action: null, aliases: [], availableDuringTask: false, supportsInlineArgs: false, unavailableReason: "当前桌面壳还没有接入官方 /init 写入流程。" },
  ...
  { id: "theme", description: "选择语法高亮主题。", flavor: "official", executionKind: "unavailable", action: null, aliases: [], availableDuringTask: false, supportsInlineArgs: false, unavailableReason: "当前桌面壳还没有官方主题配置面板。" },
